		...
		<div class="row">
			<div class="col-sm-7">
				<table class="table">
					...
					<tbody>
						<tr class="movieTr" v-for="movie in movie_list" :key="i" v-on:mouseover="detail_data(movie)">
							<td>{{movie.rank}}</td>
							<td><img :src="'http://www.kobis.or.kr'+movie.thumbUrl"></td>
							<td>{{movie.movieNm}}</td>
			...
			<table class="table">
						<tr>
							<td width="30%" class="text-center" rowspan="7"><img :src="'http://www.kobis.or.kr'+movie_detail.thumbUrl"></td>
							<td colspan="2"><h3>{{movie_detail.movieNm}}</h3></td>
						</tr>
						<tr>
							<td width="20%">감독</td>
