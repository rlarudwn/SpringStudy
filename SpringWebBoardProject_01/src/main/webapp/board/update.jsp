			...
			<form action="updateOk.do" method="post">
				<table class="table">
					<tr>
						...
						<td width="80%"><input type="text" name="name" size="20" class="input input-sm" value="${detail.name}" required></td>
					</tr>
					<tr>
						<th class="text-right" width="20%">제목</th>
						<td width="80%"><input type="text" name="subject" size="20" class="input input-sm" value="${detail.subject }" required></td>
					</tr>
					<tr>
						<th class="text-right" width="20%">내용</th>
						<td width="80%"><textarea rows="10" cols="50" name="content" required>${detail.content }</textarea></td>
					</tr>
					<tr>
